<%@ Page Language="vb" AutoEventWireup="false" Codebehind="w_mninstpago.aspx.vb" Inherits="AHSB.w_mninstpago" %>
...
<HTML>
	...
	<body leftMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="WIDTH: 520px; HEIGHT: 290px" cellSpacing="1" cellPadding="1"
				width="520">
				<TR>
				...
				<TR>
					<TD style="WIDTH: 439px; HEIGHT: 20px" align="center" colSpan="6">
						<P align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:label id="lblTitulo" runat="server" Font-Names="Arial" Font-Bold="True" Width="205px"> Instrumentos de Pago</asp:label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 439px; HEIGHT: 117px" align="center" colSpan="6">&nbsp;
						<TABLE id="Table2" style="WIDTH: 494px; HEIGHT: 93px" cellSpacing="0" cellPadding="1" width="481"
							align="center" border="2">
							<TR>
								<TD style="WIDTH: 132px; HEIGHT: 34px" vAlign="middle" align="center"><asp:label id="lblCoperacion" runat="server" Font-Names="Arial" Font-Size="8pt" Font-Bold="True"
										Width="109px" Height="32px">Codigo Inst. Pago</asp:label></TD>
								<TD style="HEIGHT: 34px" align="left">&nbsp;
									<asp:textbox id="txtInstPago" runat="server" Font-Names="Arial" Font-Size="9pt" Width="68px"
										Visible="False" ToolTip="Código de Operación " Height="19px" MaxLength="6"></asp:textbox>
									<asp:RangeValidator id="RangeValidator1" runat="server" Font-Bold="True" ErrorMessage="*" MinimumValue="100000"
										MaximumValue="999999" ControlToValidate="txtInstPago"></asp:RangeValidator></TD>
							</TR>
							<TR>
								...
								<TD style="HEIGHT: 53px" align="left">&nbsp;
									<asp:dropdownlist id="cmbInstPago" runat="server" Font-Names="Arial" Font-Size="9pt" Width="328px"
										AutoPostBack="True"></asp:dropdownlist>&nbsp;
									<asp:textbox id="txtDescripcion" runat="server" Font-Names="Arial" Font-Size="9pt" Width="328px"
										Visible="False" ToolTip="Descripción del Código de Instrumento de Pago" Height="28px" MaxLength="100"
