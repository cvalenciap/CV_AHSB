<%@ Page Language="vb" AutoEventWireup="false" Codebehind="w_mncomision.aspx.vb" Inherits="AHSB.w_mncomision" %>
			...
			<TABLE id="Table1" style="WIDTH: 520px; HEIGHT: 290px" cellSpacing="1" cellPadding="1"
				...
				<TR>
					<TD style="WIDTH: 439px; HEIGHT: 20px" align="center" colSpan="6">
						<P align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:label id="lblTitulo" runat="server" Font-Names="Arial" Font-Bold="True" Width="179px"> Comisión BCR</asp:label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
					</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 439px; HEIGHT: 117px" align="center" colSpan="6">&nbsp;
						<TABLE id="Table2" style="WIDTH: 508px; HEIGHT: 113px" cellSpacing="0" cellPadding="1"
							width="508" align="center" border="2">
							<TR>
								<TD style="WIDTH: 132px; HEIGHT: 34px" vAlign="middle" align="center"><asp:label id="lblcCanal" runat="server" Font-Names="Arial" Font-Size="8pt" Font-Bold="True"
										Width="115px" Height="15px">Codigo de Comisión</asp:label></TD>
								<TD style="HEIGHT: 34px" align="left">&nbsp;
									<asp:textbox id="txtComisBCR" runat="server" Font-Names="Arial" Font-Size="9pt" Width="68px"
										Visible="False" ToolTip="Código de Operación " Height="19px" MaxLength="2"></asp:textbox>
									<asp:RangeValidator id="RangeValidator1" runat="server" Font-Bold="True" ErrorMessage="*" ControlToValidate="txtComisBCR"
										MinimumValue="01" MaximumValue="99"></asp:RangeValidator></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 132px; HEIGHT: 53px" vAlign="middle" align="center">&nbsp;
									<asp:label id="lblDescripcion" runat="server" Font-Names="Arial" Font-Size="8pt" Font-Bold="True"
										Width="85px" Height="9px">Descripción</asp:label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
								<TD style="HEIGHT: 53px" align="left">&nbsp;
									<asp:dropdownlist id="cmbComisBCR" runat="server" Font-Names="Arial" Font-Size="9pt" Width="336px"
										AutoPostBack="True" Height="29px"></asp:dropdownlist>&nbsp;
									<asp:textbox id="txtDescripcion" runat="server" Font-Names="Arial" Font-Size="9pt" Width="336px"
										Visible="False" ToolTip="Descripción del Código de Canal de Atención" Height="29px" TextMode="MultiLine"></asp:textbox>
