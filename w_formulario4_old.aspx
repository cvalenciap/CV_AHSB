			...
			<TABLE id="Table1" style="HEIGHT: 545px" cellSpacing="1" cellPadding="1" width="100%">
				...
				<TR>
					<TD style="WIDTH: 532px; HEIGHT: 29px" align="center" colSpan="6">
						<P align="center"><asp:label id="lblTitulo" runat="server" Font-Names="Arial" Font-Bold="True" Width="406px">Registro de Formulario Nro. 4</asp:label></P>
						<P align="center">&nbsp;</P>
					</TD>
								...
								<TABLE style="WIDTH: 486px; HEIGHT: 88px" id="Table12" border="1" cellSpacing="0" cellPadding="1"
									...
									<TR>
										<TD style="WIDTH: 60px; HEIGHT: 28px" vAlign="middle" align="left">
											<asp:label id="lbltCliente" runat="server" Font-Size="7pt" Font-Names="Arial">Tipo de Cliente</asp:label><BR>
										</TD>
										<TD style="WIDTH: 155px; HEIGHT: 28px">
											<asp:dropdownlist id="cmbTCliente" runat="server" Font-Size="7pt" Font-Names="Arial" Width="136px"
												AutoPostBack="True"></asp:dropdownlist><BR>
										</TD>
										<TD style="WIDTH: 137px; HEIGHT: 28px">&nbsp;&nbsp;
											<asp:label id="lblCodOperacion" runat="server" Font-Size="7pt" Font-Names="Arial">Código de Operación</asp:label><BR>
										</TD>
										<TD style="HEIGHT: 28px">
											<asp:dropdownlist id="cmbOperacion" runat="server" Font-Size="7pt" Font-Names="Arial" Width="88px"></asp:dropdownlist><BR>
										</TD>
									</TR>
									<TR>
										<TD style="WIDTH: 60px" vAlign="middle" align="left">
											<asp:label style="Z-INDEX: 0" id="lblMoneda" runat="server" Font-Size="7pt" Font-Names="Arial">Moneda</asp:label></TD>
										<TD style="WIDTH: 155px">
											<asp:dropdownlist style="Z-INDEX: 0" id="cmbMoneda" runat="server" Font-Size="7pt" Font-Names="Arial"
									...
									<TR>
										<TD style="WIDTH: 60px" vAlign="middle" align="left">
											<asp:label style="Z-INDEX: 0" id="lbCanal" runat="server" Font-Size="7pt" Font-Names="Arial">Canal</asp:label></TD>
										<TD style="WIDTH: 155px">
											<asp:dropdownlist style="Z-INDEX: 0" id="cmbCanal" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="88px"></asp:dropdownlist></TD>
										<TD style="WIDTH: 137px">&nbsp;&nbsp;
											<asp:label style="Z-INDEX: 0" id="lblPlaza" runat="server" Font-Size="7pt" Font-Names="Arial">Plaza</asp:label></TD>
										<TD>
											<asp:dropdownlist style="Z-INDEX: 0" id="cmbPlaza" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="88px"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 60px" vAlign="middle" align="left">
											<asp:label style="Z-INDEX: 0" id="lblMontoMin" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="80px">Monto Mínimo</asp:label></TD>
										<TD style="WIDTH: 155px">
											<asp:textbox style="Z-INDEX: 0" id="txtMontoMin" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="104px" ReadOnly="True"></asp:textbox></TD>
										<TD style="WIDTH: 137px">&nbsp;&nbsp;
											<asp:label style="Z-INDEX: 0" id="lblMontoMax" runat="server" Font-Size="7pt" Font-Names="Arial">Monto Máximo</asp:label></TD>
										<TD>
											<asp:textbox style="Z-INDEX: 0" id="txtMontoMax" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="104px" Visible="False" ReadOnly="True"></asp:textbox></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 60px" vAlign="middle" align="left">
											<asp:label style="Z-INDEX: 0" id="lblTasa" runat="server" Font-Size="7pt" Font-Names="Arial">Tasa</asp:label></TD>
										<TD style="WIDTH: 155px">
											<asp:textbox style="Z-INDEX: 0" id="txtTasa" runat="server" Font-Size="7pt" Font-Names="Arial"
												Width="104px" ReadOnly="True"></asp:textbox></TD>
										<TD style="WIDTH: 137px" colSpan="2">&nbsp;&nbsp;&nbsp;
											<asp:label style="Z-INDEX: 0" id="lblObservaciones" runat="server" Font-Size="7pt" Font-Names="Arial">Observaciones</asp:label>&nbsp;
											<asp:TextBox style="Z-INDEX: 0" id="TextBox1" runat="server" Width="319px" TextMode="MultiLine"></asp:TextBox></TD>
									</TR>
									<DIV></DIV>
								</TABLE>
							</DIV>
