	...
	if (currentlySelected != null)
	{
		...
		if (e.keyCode == 13)
		{
			if (currentlySelected.childNodes.length > 0)
			{
				...
				if (workNode.childNodes[0] != null && workNode.childNodes[0].nodeName.toLowerCase() == "input")
				{
	...
	{	
		...
		if (ob_od.id == tree_selected_id)
		{
			...
			if (ob_od.childNodes.length > 0)
			{
				...
				if (workNode.childNodes[0] != null && workNode.childNodes[0].nodeName.toLowerCase() == "#text")
				{
