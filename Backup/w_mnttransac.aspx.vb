...
Public Class w_mnttransac
   ...
   Protected WithEvents cmbTtxn As System.Web.UI.WebControls.DropDownList
...
#Region "**** Cargar Controles*****"
   ...
   Private Sub Cargar_Controles()
      ...
      Dim dsControles As DataSet = oDBSQL.Get_FormMNTTransac(ErrMsg)

      DTOperacion = dsControles.Tables("Transaccion")



      Me.cmbTtxn.DataSource = DTOperacion
      Me.cmbTtxn.DataValueField = DTOperacion.Columns(0).ColumnName
      Me.cmbTtxn.DataTextField = DTOperacion.Columns(1).ColumnName
      Me.cmbTtxn.DataBind()
...
#Region "*** Opcion Proceso ****"
   ...
   Private Sub cmdModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdModificar.Click
      ...
      txtDescripcion.Text = Me.cmbTtxn.SelectedItem.Text
      txtCOperacion.Text = Me.cmbTtxn.SelectedValue.ToString
...
#Region "*** Interaccion BD ***"
   ...
   Private Sub EjecutaProceso()
      ...
      If Session("Accion") > 1 Then
         Codigo = Me.cmbTtxn.SelectedValue
      Else
         Codigo = CInt(Me.txtCOperacion.Text)
      End If
      Descripcion = txtDescripcion.Text.Trim.ToUpper
      ...
      Try
         ...
         Select Case Session("Accion")
            ...
            Case Is = 1
               ...
               Try
                  oDBSQL.Grabar_FormMNTTransac(Codigo, Descripcion, CodUsuario)
               ...
               mensaje = "Tipo de Transacción Adicionado"

            Case Is = 2
               oDBSQL.Modificar_FormMNTTransac(Codigo, Descripcion, CodUsuario)
               mensaje = "Tipo de Transacción  Modificado"

            Case Is = 3
               'oDBSQL.Eliminar_FormMNTTransac(Codigo, CodUsuario)
               'mensaje = "Tipo de Transacción Eliminado"
...
#End Region
   ...
   Private Sub cmbTtxn_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

      Dim dvOperacion As New DataView
      dvOperacion = DTOperacion.DefaultView
      dvOperacion.RowFilter = "ID_Codigo = " & CType(Me.cmbTtxn.SelectedValue, String)
