...
<HTML xmlns:asp>
		...
		{	
			...
			{	parselimit-=1
				...
				if (curmin!=0)
					...
					curtime="Redirección Automatica en " + cursec + " segundo(s)"
	...
	<body onLoad="begintimer()">
				...
				<TR>
					...
					<TD>
						<asp:label id="Label9" Width="427px" Font-Names="Garamond" Font-Size="Medium" Font-Overline="True"
							...
							<STRONG><U><FONT face="Arial">La&nbsp;Sesión Actual ha Caducado...</FONT></U></STRONG></asp:label></TD>
				</TR>
			</TABLE>
		</P>
		<P>&nbsp;</P>
		...
		<P align="center"><STRONG><FONT face="Arial"><EM>Si la aplicación esta inactiva,&nbsp;<STRONG><FONT face="Arial"><EM>por 
									seguridad, </EM></FONT></STRONG>la </EM></FONT></STRONG>
		</P>
		<P align="center"><STRONG><FONT face="Arial"><EM>sesión caduca </EM></FONT></STRONG>
			<STRONG><FONT face="Arial"><EM>después </EM></FONT></STRONG><STRONG><FONT face="Arial"><EM>de 
